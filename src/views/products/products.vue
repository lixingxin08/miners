<template>
    <div class="products">
        <div class="content pro_banner flex_fs">
            ...
            <div class="flex_fs pro_bn_i" v-for="item in 3" :key="item">
                ...
                <div class="pro_bn_ir flex_a">
                    <div>
                        <div class="font_16" style="text-align:left">{{bannerdata[item].title}}</div>
                        <div class="font_16" style="text-align:left;margin-top: 10px;">
        ...
        <div class="content" style="margin-bottom:20px">
            <div class="pro_i flex_fs font_16">
                ...
                <div class="pro_ir ">
                    <div class="flex_fs">
                        ...
                        <div class="pro_ir_i" v-for="(item,index) in productsList.product" :key="index"
                            @click="selpro(item.id)">
                            <div :class="$route.query.id==item.id?'color1':'ishover'"> {{item.cname}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="pro_ir ">
                    <div class="flex_fs">
                        ...
                        <div class="pro_ir_i" v-for="(item,index) in productsList.company" :key="index"
                            ...
                            <div :class="selcompanyid==index?'color1':'ishover'"> {{item.cname}}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pro_r extent_box">
                <div class="pro_r flex_b" v-if="listtype">
                    <div class="box_flex box_shadown pro_r_box" v-for="(item,index) in productsInfo" :key="index">
                        ...
                        <div class="btn_box" @click="changevisi(item)">
